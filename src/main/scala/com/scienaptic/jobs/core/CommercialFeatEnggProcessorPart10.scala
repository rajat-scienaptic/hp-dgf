...
object CommercialFeatEnggProcessor10 {
  ...
  def execute(executionContext: ExecutionContext): Unit = {
    ...
    commercial.write.option("header","true").mode(SaveMode.Overwrite).csv("/etherData/Pricing/Outputs/Preregression_Commercial/preregresion_commercial_output_"+currentTS+".csv")
  }
