...
object CommercialFeatEnggProcessor10 {
  ...
  def execute(executionContext: ExecutionContext): Unit = {
    ...
    commercialFinalOut
      ...
      .coalesce(1).write.option("header","true").mode(SaveMode.Overwrite).csv("/etherData/Pricing/Outputs/Preregression_Commercial/temp/preregresion_commercial_output_"+currentTS+".csv")
  }
