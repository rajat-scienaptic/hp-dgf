...
object RetailPreRegressionPart16 {
  ...
  def execute(executionContext: ExecutionContext): Unit = {
    ...
    var retailWithCompCann3DF  = executionContext.spark.read.option("header", true).option("inferSchema", true).csv("/etherData/retailTemp/RetailFeatEngg/retail-CateCannOfflineOnline-PART15.csv")
