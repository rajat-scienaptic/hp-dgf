...
object RetailPreRegressionPart22 {
  ...
  def execute(executionContext: ExecutionContext): Unit = {
    ...
    excluded.coalesce(1).write.mode(SaveMode.Overwrite).option("header", true).csv("file:///home/ether/Pricing/reporting/" + currentTS + "/final/Preregression_Retail_Excluded.csv")
  }
}
