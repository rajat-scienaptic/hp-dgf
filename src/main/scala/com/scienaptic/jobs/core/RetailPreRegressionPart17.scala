...
object RetailPreRegressionPart17 {
  ...
  def execute(executionContext: ExecutionContext): Unit = {
    ...
    var retailWithCompCann3DF  = executionContext.spark.read.option("header", true).option("inferSchema", true).csv("/etherData/retailTemp/RetailFeatEngg/retail-DirectCann-PART16.csv")
    ...
    retailWithCompCann3DF.select("SKU","Week_End_Date","Account","mnth","Online","trend","SKU_Name","L1_Category",
      ...
      "HPS_OPS","Series","Category_Custom","Brand","Max_Week_End_Date","Season_Ordered","Cal_Month","Cal_Year","Fiscal_Qtr","Fiscal_Year",
      ...
      "NP_Flag","ASP_Flag","Other_IR_Flag","Promo_Pct","Discount_Depth_Category","log_POS_Qty","price","EOL_criterion","EOL_criterion_old",
      ...
      "USWashingtonsBirthday","hol_dummy","Lag_USMemorialDay","Lag_USPresidentsDay","Lag_USThanksgivingDay","Lag_USChristmasDay",
      ...
      "Direct_Cann_Muscatel_Weber","Direct_Cann_Muscatel_Palermo","Direct_Cann_Palermo","LBB_adj","Flash_IR_dummy","exclude",
