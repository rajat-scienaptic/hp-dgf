...
public interface DGFHeaderDataService {
    ...
    ApiResponseDTO addPL(final AddPLRequestDTO addPlRequestDTO, final HttpServletRequest request, String cookie);
    ApiResponseDTO updatePL(final UpdatePLRequestDTO updatePLRequestDTO,
                            final int productLineId,
                            final HttpServletRequest request,
                            String cookie);
    ApiResponseDTO deletePL(final int productLineId, HttpServletRequest request, String cookie);
}
